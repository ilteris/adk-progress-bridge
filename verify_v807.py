...
async def verify_v807_ws():
    ...
    new_tools = [
        "system_process_cpu_times_user_avg_v4",
        "system_process_cpu_times_children_system_max_v4",
        "system_process_cpu_percent_min_v4",
        "system_process_memory_percent_sum_v4",
    ...
    try:
        async with websockets.connect(url) as websocket:
            print("\n--- Verifying v807 tools over WebSocket ---")
            ...
            print("\nAll v807 tools verified successfully over WebSocket.")
            ...
            if data['type'] == 'tools_list':
                ...
                if tools_count >= 1240:
                    print("Milestone 1240 reached!")
                else:
                    print(f"Milestone 1240 NOT reached. Current count: {tools_count}")
                    sys.exit(1)
