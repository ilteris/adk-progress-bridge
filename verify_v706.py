...
if __name__ == "__main__":
    check_version()
    test_tool("system_disk_io_read_count_ultimate_audit")
    test_tool("system_disk_io_write_count_ultimate_audit")
    test_tool("system_disk_io_read_bytes_ultimate_audit")
