...
async def run_ws_new_tools_v693():
    ...
    try:
        async with websockets.connect(url) as websocket:
            print("\n--- Testing new Disk Average tools (v2.10.19) ---")
        ...
        print(f"WS Error in run_ws_new_tools_v693: {e}")
        sys.exit(1)

if __name__ == "__main__":
    asyncio.run(run_ws_new_tools_v693())
