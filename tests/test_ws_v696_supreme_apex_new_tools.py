...
async def run_ws_new_tools_v696():
    ...
    try:
        async with websockets.connect(url) as websocket:
            print("\n--- Testing new CPU Stats Average tools (v2.10.22) ---")
        ...
        print(f"WS Error in run_ws_new_tools_v696: {e}")
        sys.exit(1)

if __name__ == "__main__":
    asyncio.run(run_ws_new_tools_v696())
