...
def test_v594_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v594.
    """
    with TestClient(app) as client:
        ...
        assert "v594" in data["git_commit"]
        assert "v594" in data["status"]
