...
def test_v660_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v660.
    """
    with TestClient(app) as client:
        ...
        assert "v660" in data["git_commit"]
        assert "v660" in data["status"]
