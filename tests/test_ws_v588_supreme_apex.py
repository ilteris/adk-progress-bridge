...
def test_v677_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v677.
    """
    with TestClient(app) as client:
        ...
        assert "v677" in data["git_commit"]
