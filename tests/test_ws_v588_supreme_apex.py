...
def test_v628_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v628.
    """
    with TestClient(app) as client:
        ...
        assert "v628" in data["git_commit"]
        assert "v628" in data["status"]
