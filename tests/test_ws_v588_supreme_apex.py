...
def test_v589_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v589.
    """
    with TestClient(app) as client:
        ...
        assert "v589" in data["git_commit"]
        assert "v589" in data["status"]
