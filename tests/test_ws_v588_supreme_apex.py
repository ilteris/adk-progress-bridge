...
def test_v655_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v655.
    """
    with TestClient(app) as client:
        ...
        assert "v655" in data["git_commit"]
        assert "v655" in data["status"]
