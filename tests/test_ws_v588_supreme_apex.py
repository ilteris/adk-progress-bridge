...
def test_v666_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v666.
    """
    with TestClient(app) as client:
        ...
        assert "v666" in data["git_commit"]
        assert "v666" in data["status"]
