...
def test_v653_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v653.
    """
    with TestClient(app) as client:
        ...
        assert "v653" in data["git_commit"]
        assert "v653" in data["status"]
