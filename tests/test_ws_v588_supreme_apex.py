...
def test_v658_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v658.
    """
    with TestClient(app) as client:
        ...
        assert "v658" in data["git_commit"]
        assert "v658" in data["status"]
