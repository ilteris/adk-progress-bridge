...
def test_v663_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v663.
    """
    with TestClient(app) as client:
        ...
        assert "v663" in data["git_commit"]
        assert "v663" in data["status"]
