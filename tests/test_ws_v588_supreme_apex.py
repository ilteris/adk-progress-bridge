...
def test_v652_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v652.
    """
    with TestClient(app) as client:
        ...
        assert "v652" in data["git_commit"]
        assert "v652" in data["status"]
