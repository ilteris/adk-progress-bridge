...
def test_v595_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v595.
    """
    with TestClient(app) as client:
        ...
        assert "v595" in data["git_commit"]
        assert "v595" in data["status"]
