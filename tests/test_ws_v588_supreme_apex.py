...
def test_v673_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v673.
    """
    with TestClient(app) as client:
        ...
        assert "v673" in data["git_commit"]
        assert "v673" in data["status"]
