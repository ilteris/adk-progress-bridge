...
def test_v622_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v622.
    """
    with TestClient(app) as client:
        ...
        assert "v622" in data["git_commit"]
        assert "v622" in data["status"]
