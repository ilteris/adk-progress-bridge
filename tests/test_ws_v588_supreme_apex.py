...
def test_v647_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v647.
    """
    with TestClient(app) as client:
        ...
        assert "v647" in data["git_commit"]
        assert "v647" in data["status"]
