...
def test_v657_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v657.
    """
    with TestClient(app) as client:
        ...
        assert "v657" in data["git_commit"]
        assert "v657" in data["status"]
