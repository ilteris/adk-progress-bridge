...
@pytest.mark.asyncio
async def test_ws_v603_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.1.7 and v603 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.2.9"
        assert "v603" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v603_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v603_multi_connection_concurrency():
    """
