...
@pytest.mark.asyncio
async def test_ws_v653_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.7.9 and v653 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.7.9"
        assert "v653" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v653_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v653_multi_connection_concurrency():
    """
