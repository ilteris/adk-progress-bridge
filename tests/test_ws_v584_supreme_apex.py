...
@pytest.mark.asyncio
async def test_ws_v589_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.1.5 and v589 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.1.5"
        assert "v589" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v589_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v589_multi_connection_concurrency():
    """
