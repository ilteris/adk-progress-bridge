...
@pytest.mark.asyncio
async def test_ws_v587_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.1.3 and v587 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.1.3"
        assert "v587" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v587_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v587_multi_connection_concurrency():
    """
