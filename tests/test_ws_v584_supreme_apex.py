...
@pytest.mark.asyncio
async def test_ws_v656_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.8.2 and v656 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.8.2"
        assert "v656" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v656_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v656_multi_connection_concurrency():
    """
