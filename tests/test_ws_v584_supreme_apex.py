...
@pytest.mark.asyncio
async def test_ws_v666_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.9.2 and v666 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.9.2"
        assert "v666" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v666_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v666_multi_connection_concurrency():
    """
