...
@pytest.mark.asyncio
async def test_ws_v660_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.8.6 and v660 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.8.6"
        assert "v660" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v660_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v660_multi_connection_concurrency():
    """
