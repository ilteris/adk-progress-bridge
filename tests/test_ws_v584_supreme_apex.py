...
@pytest.mark.asyncio
async def test_ws_v654_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.8.0 and v654 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        assert "v654" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v654_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v654_multi_connection_concurrency():
    """
