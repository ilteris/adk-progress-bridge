...
@pytest.mark.asyncio
async def test_ws_v651_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.7.7 and v651 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.7.7"
        assert "v651" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v651_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v651_multi_connection_concurrency():
    """
