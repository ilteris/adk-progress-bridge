...
@pytest.mark.asyncio
async def test_ws_v659_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.8.5 and v659 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.8.5"
        assert "v659" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v659_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v659_multi_connection_concurrency():
    """
