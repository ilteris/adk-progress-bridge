...
@pytest.mark.asyncio
async def test_ws_v608_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.1.7 and v608 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.3.4"
        assert "v608" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v608_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v608_multi_connection_concurrency():
    """
