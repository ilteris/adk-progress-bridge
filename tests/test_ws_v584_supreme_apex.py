...
@pytest.mark.asyncio
async def test_ws_v650_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.7.6 and v650 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.7.6"
        assert "v650" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v650_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v650_multi_connection_concurrency():
    """
