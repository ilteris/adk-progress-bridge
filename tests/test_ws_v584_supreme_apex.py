...
@pytest.mark.asyncio
async def test_ws_v627_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.1.7 and v627 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.5.3"
        assert "v627" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v627_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v627_multi_connection_concurrency():
    """
