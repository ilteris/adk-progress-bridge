...
@pytest.mark.asyncio
async def test_ws_v665_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.9.1 and v665 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.9.1"
        assert "v665" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v665_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v665_multi_connection_concurrency():
    """
