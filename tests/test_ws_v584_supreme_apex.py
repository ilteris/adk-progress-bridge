...
@pytest.mark.asyncio
async def test_ws_v655_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.8.1 and v655 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.8.1"
        assert "v655" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v655_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v655_multi_connection_concurrency():
    """
