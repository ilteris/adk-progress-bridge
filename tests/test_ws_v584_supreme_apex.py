...
@pytest.mark.asyncio
async def test_ws_v590_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.1.6 and v590 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.1.6"
        assert "v590" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v590_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v590_multi_connection_concurrency():
    """
