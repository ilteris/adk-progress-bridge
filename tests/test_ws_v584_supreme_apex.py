...
@pytest.mark.asyncio
async def test_ws_v663_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.8.9 and v663 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.8.9"
        assert "v663" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v663_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v663_multi_connection_concurrency():
    """
