...
@pytest.mark.asyncio
async def test_ws_v638_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.1.7 and v638 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.6.4"
        assert "v638" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v638_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v638_multi_connection_concurrency():
    """
