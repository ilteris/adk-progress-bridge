...
@pytest.mark.asyncio
async def test_ws_v598_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.1.7 and v598 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        assert "v598" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v598_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v598_multi_connection_concurrency():
    """
