...
@pytest.mark.asyncio
async def test_ws_v602_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.1.7 and v602 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.2.8"
        assert "v602" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v602_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v602_multi_connection_concurrency():
    """
