...
@pytest.mark.asyncio
async def test_ws_v652_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.7.8 and v652 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.7.8"
        assert "v652" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v652_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v652_multi_connection_concurrency():
    """
