...
@pytest.mark.asyncio
async def test_ws_v664_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.9.0 and v664 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        assert "v664" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v664_boundary_conditions():
    """
...
@pytest.mark.asyncio
async def test_ws_v664_multi_connection_concurrency():
    """
