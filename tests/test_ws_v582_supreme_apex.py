...
@pytest.mark.asyncio
async def test_ws_v582_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.0.8 and v582 markers
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        health = data["data"]
        assert health["version"] == "2.0.8"
        assert "v582" in health["operational_apex"]
...
@pytest.mark.asyncio
async def test_ws_v582_boundary_conditions():
    """
