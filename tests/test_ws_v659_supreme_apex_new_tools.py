...
def test_ws_v664_new_tools():
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        # List tools
        websocket.send_json({"type": "list_tools", "request_id": "v664_list"})
        ...
        # Test tool 1
        req_id = "v664_test_packets_sent_total"
        websocket.send_json({
            "type": "start",
        ...
        # Test tool 2
        req_id = "v664_test_packets_recv_total"
        websocket.send_json({
            "type": "start",
        ...
        # Test tool 3
        req_id = "v664_test_read_count_total"
        websocket.send_json({
            "type": "start",
