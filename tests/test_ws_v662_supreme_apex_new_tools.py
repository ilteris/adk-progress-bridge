...
def test_ws_v662_new_tools():
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        # List tools
        websocket.send_json({"type": "list_tools", "request_id": "v662_list"})
        ...
        # Test tool 1
        req_id = "v662_test_write_time_total"
        websocket.send_json({
            "type": "start",
        ...
        # Test tool 2
        req_id = "v662_test_busy_time_total"
        websocket.send_json({
            "type": "start",
        ...
        # Test tool 3
        req_id = "v662_test_ctx_switches_total"
        websocket.send_json({
            "type": "start",
