...
def test_ws_v667_new_tools():
    ...
    with client.websocket_connect("/ws?api_key=test-key") as websocket:
        ...
        # List tools
        websocket.send_json({"type": "list_tools", "request_id": "v667_list"})
        ...
        # Test tool 1
        req_id = "v667_test_guest_nice_total"
        websocket.send_json({
            "type": "start",
        ...
        # Test tool 2
        req_id = "v667_test_net_io_sent_total"
        websocket.send_json({
            "type": "start",
        ...
        # Test tool 3
        req_id = "v667_test_net_io_recv_total"
        websocket.send_json({
            "type": "start",
