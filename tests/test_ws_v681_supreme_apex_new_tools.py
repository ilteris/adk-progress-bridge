...
async def run_ws_new_tools_v681():
    ...
    try:
        async with websockets.connect(url) as websocket:
            print("\n--- Testing new disk I/O average tools (v2.10.7) ---")
            
            new_tools = [
                "system_disk_io_write_count_avg_audit",
        ...
        print(f"WS Error in run_ws_new_tools_v681: {e}")
        sys.exit(1)

if __name__ == "__main__":
    asyncio.run(run_ws_new_tools_v681())
