...
def test_v587_metadata_verification():
    """
    Verifies that the version and metadata are correctly updated for v587.
    """
    with TestClient(app) as client:
        ...
        assert "v587" in data["git_commit"]
        assert "v587" in data["status"]