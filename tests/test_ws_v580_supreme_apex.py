...
@pytest.mark.asyncio
async def test_ws_v580_supreme_apex_comprehensive():
    """
    ...
    3. Verify health data includes v2.0.5 and v579/v580 markers
...
@pytest.mark.asyncio
async def test_ws_v580_boundary_conditions():
    """
