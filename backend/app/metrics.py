...
# v360 THE ASCENSION Metrics
SYSTEM_CPU_SOFT_INTERRUPT_RATE_BPS = Gauge(
    "adk_system_cpu_soft_interrupt_rate_per_sec",
    "Current rate of system-wide soft interrupts per second"
)

SYSTEM_CPU_SYSCALL_RATE_BPS = Gauge(
    "adk_system_cpu_syscall_rate_per_sec",
    "Current rate of system-wide system calls per second"
)
...
# Pre-initialize labels to ensure they show up in /metrics even if zero
WS_CONNECTION_ERRORS_TOTAL.labels(error_type="auth_failure")
WS_CONNECTION_ERRORS_TOTAL.labels(error_type="protocol_error")
WS_CONNECTION_ERRORS_TOTAL.labels(error_type="other_error")
