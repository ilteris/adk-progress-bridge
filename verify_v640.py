...
if __name__ == "__main__":
    test_tool("system_net_if_addrs_netmask_audit")
    test_tool("system_disk_partitions_mountpoint_audit", {"mountpoint": "/"})
    test_tool("system_cpu_times_percent_user_focused_audit")
